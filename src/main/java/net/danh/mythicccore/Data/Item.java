...
public class Item {
    ...
    public static void upgradeItem(Player p, Inventory inventory, ItemStack weapon, ItemStack upgradestone1, ItemStack upgradestone2, ItemStack upgradestone3, ItemStack upgradestone4, ItemStack upgradestone5, ItemStack upgradestone6, ItemStack upgradestone7, ItemStack upgradestone8) {
        if (weapon != null && upgradestone1 != null && upgradestone2 != null && upgradestone3 != null && upgradestone4 != null && upgradestone5 != null && upgradestone6 != null && upgradestone7 != null && upgradestone8 != null) {
            ...
            if (nbtweapon.hasType() && Objects.equals(nbtweapon.getType(), getupgradeString(nbtweapon.getString("MMOITEMS_ITEM_ID") + ".WEAPON_MATERIAL"))) {
                if (nbtupgradestone1.hasType() && nbtupgradestone2.hasType() && nbtupgradestone3.hasType() && nbtupgradestone4.hasType() && nbtupgradestone5.hasType() && nbtupgradestone6.hasType() && nbtupgradestone7.hasType() && nbtupgradestone8.hasType()) {
                    if (Objects.equals(nbtupgradestone1.getType(), getupgradeString(nbtweapon.getString("MMOITEMS_ITEM_ID") + ".UPGRADE_STONE_MATERIAL")) && Objects.equals(nbtupgradestone2.getType(), nbtupgradestone1.getType()) && Objects.equals(nbtupgradestone3.getType(), nbtupgradestone1.getType()) && Objects.equals(nbtupgradestone4.getType(), nbtupgradestone1.getType()) && Objects.equals(nbtupgradestone5.getType(), nbtupgradestone1.getType()) && Objects.equals(nbtupgradestone6.getType(), nbtupgradestone1.getType()) && Objects.equals(nbtupgradestone7.getType(), nbtupgradestone1.getType()) && Objects.equals(nbtupgradestone8.getType(), nbtupgradestone1.getType())) {
                        if (Objects.equals(nbtupgradestone1.getString("MMOITEMS_ITEM_ID"), getupgradeString(nbtweapon.getString("MMOITEMS_ITEM_ID") + ".UPGRADE_STONE")) && Objects.equals(nbtupgradestone2.getString("MMOITEMS_ITEM_ID"), getupgradeString(nbtweapon.getString("MMOITEMS_ITEM_ID") + ".UPGRADE_STONE")) && Objects.equals(nbtupgradestone3.getString("MMOITEMS_ITEM_ID"), getupgradeString(nbtweapon.getString("MMOITEMS_ITEM_ID") + ".UPGRADE_STONE")) && Objects.equals(nbtupgradestone4.getString("MMOITEMS_ITEM_ID"), getupgradeString(nbtweapon.getString("MMOITEMS_ITEM_ID") + ".UPGRADE_STONE")) && Objects.equals(nbtupgradestone5.getString("MMOITEMS_ITEM_ID"), getupgradeString(nbtweapon.getString("MMOITEMS_ITEM_ID") + ".UPGRADE_STONE")) && Objects.equals(nbtupgradestone6.getString("MMOITEMS_ITEM_ID"), getupgradeString(nbtweapon.getString("MMOITEMS_ITEM_ID") + ".UPGRADE_STONE")) && Objects.equals(nbtupgradestone7.getString("MMOITEMS_ITEM_ID"), getupgradeString(nbtweapon.getString("MMOITEMS_ITEM_ID") + ".UPGRADE_STONE")) && Objects.equals(nbtupgradestone8.getString("MMOITEMS_ITEM_ID"), getupgradeString(nbtweapon.getString("MMOITEMS_ITEM_ID") + ".UPGRADE_STONE"))) {
